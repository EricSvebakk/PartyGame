...
val dares = mutableMapOf(
    ...
    4 to mutableListOf(
        ...
        "Are you crying? Do a suicide shot (Tequila shot, snort the salt, squeeze the lime in your eye). If you do not have the ingredients for a suicide shot, improvise.",
...
val chances = mutableListOf(
    "Half the number of drinks!",
    "Double the number of drinks!",
    "The person to your left has to drink instead!",
    "Splash Zone! the people sitting next to you must also drink half the number of drinks you must drink!",
    "You get to choose who will drink for you instead",
    "Pick a drinking buddy who must drink with you from now on! :)",
    "Everyone has to move one seat to the left. leave your drink!"
)